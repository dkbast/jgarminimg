...
public interface TransformedMapListener
{
     ...
     * @param xPoints  The X coordinates in pixels. Don't keep a pointer on it for more than the duration of this call.
     * @param yPoints  Same as xPoints, but for y coordinates.
