 ...
 * (use {@link org.free.garminimg.CoordUtils#toWGS84(int)}).
 */
public interface MapListener
{
    /**
     * Will be called for every points.
     * @param type      Type of points (see {@link org.free.garminimg.utils.ImgConstants#getPointDesc(int,int)}).
     * @param subType   Sub type.
     * @param longitude The longitude in garmin coordinates.
     * @param latitude  The latitude in garmin coordinates.
     * @param label     The label attached to this point or null if there is none.
     * @param indexed   True if the point is indexed.
     */
     ...
     * @param type       Type of polyline/gone (see {@link org.free.garminimg.utils.ImgConstants#getPolyDesc(int,boolean)}).
     * @param longitudes The longitudes in garmin coordinates. Don't keep a pointer on it for more than the duration of this call.
     * @param latitudes  Same as latitudes, but for longitudes.
